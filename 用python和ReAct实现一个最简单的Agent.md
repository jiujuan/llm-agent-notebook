...
这里用 ReAct 来写一个最简单的 Agent，调用 DeepSeek 的 API + CLI 进行多轮对话的 Agent。
...
![agent运行](./images/agent-react-demo-start-img.png)

<img src="./images/agent-react-demo-start-img-02.png" alt="agent运行2" style="zoom: 80%;" />
...
![运行Agent](./images/agent-react-demo2-start-img-01.png)

询问：最近关于羽毛球亚锦赛夺冠信息有哪些

![运行Agent](./images/agent-react-demo2-start-img-02.png)
